...
export enum STUDENT_ROLE {
  'STUDENT_ROLE_APPROVED' = 'STUDENT_ROLE_APPROVED',
  'STUDENT_ROLE_NOT_APPROVED' = 'STUDENT_ROLE_NOT_APPROVED',
}
export const CONST_USER_ROLE = Object.values(STUDENT_ROLE);

export enum STUDENT_ROLE_STATUS {
  'APPROVAL' = 'APPROVAL',
  'DELETED' = 'DELETED',
  'DENIED' = 'DENIED',
  'REFUSED' = 'REFUSED',
...
export const CONST_STUDENT_ROLE_STATUS = Object.values(STUDENT_ROLE_STATUS);
